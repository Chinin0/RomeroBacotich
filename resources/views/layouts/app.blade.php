...
<!-- Template CSS
    ...
    <!-- aqui el modo niño -->
    @if(Auth::user()->estilo == 'niño')
    <link rel="stylesheet" href="{{ asset('web/css/niño/style.css') }}">
    <link rel="stylesheet" href="{{ asset('web/css/niño/components.css')}}">
    @endif
...
@php
    ...
    function esDeNoche() {
        date_default_timezone_set('America/La_Paz'); //para que tome la hora de bolivia
        $horaActual = date('H');
